...
public class HeatHandler {
	...
	public static double getEnvHeatAround(World world, int x, int y, int z){
		...
		double heat = getEnvHeat(world, x, y, z)+getEnvHeat(world, x, y-1, z)+getEnvHeat(world, x+1, y, z)
				+getEnvHeat(world, x-1, y, z)+getEnvHeat(world, x, y, z+1)+getEnvHeat(world, x, y, z-1);
