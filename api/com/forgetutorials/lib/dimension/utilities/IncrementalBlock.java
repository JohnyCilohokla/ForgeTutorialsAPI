...
public class IncrementalBlock extends IncrementalObject {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = (prime * result) + Block.getIdFromBlock(this.block.block);
		result = (prime * result) + this.block.block.getUnlocalizedName().hashCode();
		result = (prime * result) + this.block.metadata;
		return result;
	}
	...
	public String toString() {
		return this.block.toString() + " " + this.metadata;
	}
}
